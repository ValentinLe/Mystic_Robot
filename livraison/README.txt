...
====================GUIDE D'UTILISATION POUR MYSTIC ROBOT====================
...
exemple $ sh runGui.sh 20 500
ou bien utiliser sh runGuiDefaultArgs.sh qui execute le script précédent avec les paramettre 20 joueurs et 500 millisecondes de delai
entre chaque action de joueur
...
Pour enlever tout les .class il suffit de lance le script clean.sh


----------------------------------------------------------------OPTIONEL---------------------------------------------------------

Pour lancer la compilation de la Javadoc makedoc.sh, elle va créer un dossier doc/  avec la Javadoc à l'intérieur.

Pour créer le jar il faut lancer le script makejar.sh
